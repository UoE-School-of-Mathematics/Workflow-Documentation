...
% Collapsible box for code snippets in the HTML version
\iflatexml
    \newenvironment{snippet}[1][\LaTeX{} snippet]
        {\<details style="text-align: left; width: 100\%" closed=""> \<summary> \textbf{View #1} \</summary>}
        {\</details>}
\else
    \newenvironment{snippet}[1][\LaTeX{} snippet]
    {\textbf{#1}}
