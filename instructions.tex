...
In addition to the written instructions below, a \href{https://media.ed.ac.uk/media/BookML+LaTeX+to+HTML+Demo+%28recording%29/1_zypgaqqb}{video recording of a demo session} showing the cloud-based workflow can be found on Media Hopper.
